                ...
                <LiveDiv animate={{ from: -20, to: 0, dir: "x", delay: 0 }}>
                  ...
                  text-lg text-zinc-100 leading-snug"
                    ...
                    bg-gradient-to-br from-[#31a8ff]  to-[#001e36]"
                        ...
                        modelləmə, renderləmə və post production-da
                        təqdimatların hazırlanmasını öyrənin. Sahəyə yerində
                        ziyarətlər də daxil olmaqla, real senariləri{" "}
              ...
              lg:rounded-xl rounded-lg drop-shadow-lg w-full lg:h-full h-fit flex flex-col"
                ...
                text-zinc-100 leading-snug"
                  >
                    ...
                    şəkildə istifadə olunan üç ölçülü modelləmə programıdır.
                    Bizim dərslərimiz ilə öz kreativ potentialınızın kilidini
                    açacaq, sektorun ekspterlərindən birinci əldən texnikalar
                    öyrənəcəksiniz.
                  </p>
                </div>
              </LiveDiv>
            ...
            <div className="lg:w-1/2 flex flex-col gap-y-4">
             ...
             drop-shadow-lg backdrop-blur lg:rounded-xl rounded-lg"
              >
                ...
                text-zinc-100 leading-snug"
                >
                  AutoCAD 2D və 3D dizaynın təməl daşı olaraq dayanır və
                  memarlıq, mühəndislik və istehsalat kimi sənayelərdə dəqiq
                  çertyojlamalar vasitəsi kimi istifadə olunur. Dərslərimiz
                  AutoCAD-i mənimsəmək və rəqəmsal kətan üzərində təxəyyülünüzü
                  üzə çıxarmaqda sizə bələdçilik edəcək.
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                <p className="lg:mb-4">
                  ...
                  memarlıq əsərinin eskizini tərtib edin, Photoshop canlı və
                  pixel perfect detalları ilə təxəyyülünüzü canlandırmaq üçün
                  müraciət edəcəyiniz vasitədir.
                </p>
                <p>
          ...
          <LiveDiv animate={{ from: -20, to: 0, dir: "y", delay: 0.5 }}>
            <div className="flex flex-col items-center lg:gap-y-4 gap-y-2 lg:mb-8 mb-4">
              ...
              <p className="text-zinc-400 lg:text-2xl sm:text-xl lg:text-left text-center">
                Mütəxəssislərdən öyrənmək və bacarıqlarınızı inkşaf etdirmək
                üçün bu fürsəti qaçırmayın.
              </p>
            </div>
          </LiveDiv>
