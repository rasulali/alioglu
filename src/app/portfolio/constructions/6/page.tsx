      ...
      <div className="px-8 lg:pt-24 pt-12 lg:pb-12">
        <div className="w-full lg:mb-8 mb-2 flex items-end">
          ...
          <LiveDiv animate={{ from: -20, to: 0, dir: 'x', delay: 0.1 }}>
            <p className="lg:text-xl ml-auto w-fit text-neutral-400">Təmir Prosesi</p>
          </LiveDiv>
        </div>
        <Lightbox
          ...
          slides={[...images.map((image) => image.src),
          {
            ...
            type: "video",
            preload: "auto",
            poster: "/const_6_videos/1.jpg",
            sources: [
              {
                src: "/const_6_videos/1.webm",
                type: "video/webm",
              },
              {
                src: "/const_6_videos/1.mp4",
                type: "video/mp4",
              },
            ],
          },
        ...
        <div className="w-full flex lg:flex-row flex-col">
          ...
          <div
            ...
            <div
              className="lg:w-[calc(33.3333%-8px)] w-1/2 lg:h-1/2 lg:aspect-auto aspect-[4/3]">
              <LiveDiv animate={{ from: 0.9, to: 1, dir: 'z', delay: 9 * 0.05 }}>
                ...
                >
                  <source src='/const_6_videos/1.webm'
                    type="video/webm" />
                  <source src='/const_6_videos/1.mp4'
                    type="video/mp4" />
                </video>
              </LiveDiv>
            </div>
