...
const Construction = ({ params }: { params: { id: number } }) => {
  ...
  const videos = () => {
    ...
    return videoArray.map(({ cover, src }: VideoSlide) => ({
      ...
      sources: [
        {
          src: `/constructions/${params.id}/videos/${src.webm}`,
          type: "video/webm",
        },
        {
          src: `/constructions/${params.id}/videos/${src.mp4}`,
          type: "video/mp4",
        },
      ],
    }));
              ...
              videoArray.map((video, index) => (
                ...
                >
                  <LiveDiv animate={{ from: 0.9, to: 1, dir: "z", delay: 0.1 }}>
                    ...
                    >
                      <source
                        src={`/constructions/${params.id}/videos/${video.src.webm}`}
                        type="video/webm"
                      />
                      <source
                        src={`/constructions/${params.id}/videos/${video.src.mp4}`}
                        type="video/mp4"
                      />
                    </video>
                  </LiveDiv>
