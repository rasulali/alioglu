...
const Exterior = ({ params }: { params: { id: number } }) => {
  ...
  function nextImageUrl(src: string, size: number) {
    return `/_next/image?url=${encodeURIComponent(`/exteriors/${params.id}/images/${src}`)}&w=${size}&q=70`;
  }
          ...
          <div className="lg:w-1/2 w-full aspect-[4/3]">
            <LiveDiv animate={{ from: -20, to: 0, dir: 'x', delay: 0.2 }}>
              <Image
                ...
                quality={70}
                src={`/exteriors/${params.id}/images/hero.jpg`}
                ...
                <div key={index}
                  ...
                  <LiveDiv animate={{ from: 0.9, to: 1, dir: 'z', delay: 0.1 }}>
                    <Image
                      ...
                      height={0}
                      src={`/exteriors/${params.id}/images/${image.src}`}
                      alt={image.alt}
                      quality={70}
                    />
                  </LiveDiv>
