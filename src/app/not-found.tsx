...
const NotFound = () => {
  return (
    <main
      className="relative lg:h-[calc(100vh-268px)] sm:h-[calc(100vh-592px)] h-[calc(100vh-516px)]">
      ...
      >
        ...
        >
          <Link href="/"
            className="text-neutral-400 font-black flex items-center
          justify-center gap-x-2 w-fit h-fit lg:px-8 lg:py-4 sm:px-6 sm:py-3
          px-4 py-2 bg-grayALight
