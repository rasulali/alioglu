    ...
    <div>
      ...
      >
        ...
        <Image
          ...
          src="/partners/zafaroglu.svg" alt="Zafaroglu logo" width={0} height={0} />
        <Image
          className="h-32 w-auto"
          src="/partners/knyazli.svg" alt="Zafaroglu logo" width={0} height={0} />
        <Image
          className="h-32 w-auto"
          src="/partners/cityhospital.png" alt="Zafaroglu logo" width={0} height={0} />
        <Image
          className="h-32 w-auto"
          src="/partners/xurma.jpg" alt="Zafaroglu logo" width={0} height={0} />
      </motion.span>
    </div>
  )
}
