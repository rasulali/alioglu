...
const Contact: React.FC<ContactProps> = ({ scroll }) => {
  ...
  return (
    <>
      {menuState &&
        <div
          className="fixed bg-black/50 w-screen h-screen top-0 left-0 z-50"
        />
      }
      {!menuState &&
        <AnimatePresence>
      ...
      hover:bg-zinc-100 hover:text-grayA`}
          >
            <h1
              className="block uppercase cursor-pointer text-xl sm:lg:text-2xl text-nowrap"
            >Əlaqə</h1>
          </motion.div>
        </AnimatePresence>
      }
          ...
          >
            ...
            justify-center py-4 lg:py-0 lg:justify-start bg-grayA flex flex-col ">
              ...
              <div className="flex flex-col lg:flex-row gap-y-4">
                <div className="px-6 lg:px-12 w-full h-full flex flex-col gap-y-6
                lg:w-1/2 lg:border-r-4 border-grayALight"
                >

                  <div className="border-b-2 border-grayALight pb-2 lg:border-0 lg:pb-0">
                    <h1
                      className="block text-neutral-400 text-2xl mb-1 lg:mb-2 lg:text-4xl"
                    >Telefonlar</h1>
                    <Link
                  ...
                  <div className="border-b-2 border-grayALight pb-2 lg:border-0 lg:pb-0">
                    ...
                    >Instagram</h1>
                    <Link
                      href="https://www.instagram.com/alioglu.group/" target="_blank"
                  ...
                  <div className="border-b-2 border-grayALight pb-2 lg:border-0 lg:pb-0">
                    ...
                    >Facebook</h1>
                    <Link
                      href="https://www.facebook.com/profile.php?id=61556943345997" target="_blank"
                      className="block text-xl lg:text-3xl text-zinc-100 hover:text-neutral-400 transition-colors duration-200"
                    >
                      alioglu
                    </Link>
                  ...
                  <div className="border-b-2 border-grayALight pb-2 lg:border-0 lg:pb-0">
                    ...
                    >Whatsapp</h1>
                    <Link
                      href="https://wa.me/994502989999" target="_blank"
                      className="block text-xl lg:text-3xl text-zinc-100 hover:text-neutral-400 transition-colors duration-200"
                    >
                      050 298 99 99
                    </Link>
                ...
                {/* Location */}
                <div className="px-6 lg:px-12 w-full h-full flex flex-col
                 lg:w-1/2 "
                >
                  <h1
                    className="block text-neutral-400 text-2xl mb-1 lg:mb-2 lg:text-4xl"
                  ...
                  <div>
                    <h1
                      className="block text-neutral-400 text-lg lg:text-2xl font-thin"
                    >
                      Baş Ofis
                    </h1>
